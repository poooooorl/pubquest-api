...
exports.defaultFriendships = void 0;
exports.seedFriendships = seedFriendships;
exports.defaultFriendships = [
...
async function seedFriendships(client, users) {
    let acceptedCount = 0;
    let pendingCount = 0;
    for (const friendship of exports.defaultFriendships) {
        ...
        if (user1 && user2) {
            ...
            await client.query(`INSERT INTO friendships (requester_id, addressee_id, status)
         VALUES ($1, $2, $3)`, [user1.id, user2.id, status]);
            if (status === "ACCEPTED") {
                acceptedCount++;
            }
            else {
    ...
    console.log(`✅ Created Friendships: ${acceptedCount} accepted, ${pendingCount} pending`);
}
