...
exports.generateVenuesSeedQuery = exports.defaultVenues = void 0;
exports.seedVenues = seedVenues;
exports.defaultVenues = [
...
const generateVenuesSeedQuery = () => `
  INSERT INTO venues (name, category, location) VALUES 
  ${exports.defaultVenues
    .map((venue) => `('${venue.name.replace(/'/g, "''")}', '${venue.category}', ST_SetSRID(ST_MakePoint(${venue.lng}, ${venue.lat}), 4326))`)
    .join(",\n  ")}
  RETURNING id, name
`;
exports.generateVenuesSeedQuery = generateVenuesSeedQuery;
async function seedVenues(client) {
    const venuesRes = await client.query((0, exports.generateVenuesSeedQuery)());
    console.log(`✅ Created Venues: ${venuesRes.rows.length} (First ID: ${venuesRes.rows[0].id})`);
