...
exports.ObjectiveHandlers = void 0;
exports.handleLocationObjective = handleLocationObjective;
exports.handleSpendObjective = handleSpendObjective;
/**
 * Registry of objective handlers by type
 */
exports.ObjectiveHandlers = {
 ...
 */
function handleLocationObjective(objective, event, currentProgress) {
 ...
 */
function handleSpendObjective(objective, event, currentProgress) {
    if (event.type !== "SPEND") {
        return { satisfied: false, newProgress: currentProgress };
    }
    const data = event.data;
